...
describe('LinhasDeCuidado', () => {
  ...
  test('deve chamar navigate ao clicar no item de manejo', () => {
    const item = renderedObject.getByTestId('cartaoHome-linhasDeCuidado-manejoCovid');
  ...
  test('deve chamar navigate ao clicar no item de materno infantil', () => {
    const item = renderedObject.getByTestId('cartaoHome-linhasDeCuidado-maternoInfantil');
    fireEvent.press(item);
  ...
  test('deve chamar navigate ao clicar no item de protocolos', () => {
    const item = renderedObject.getByTestId('cartaoHome-linhasDeCuidado-protocolos');
    fireEvent.press(item);
