  ...
  const secoes = [
    ...
    secao3 => (
      <Paragraph key="3">
        ...
        {secao3.texto1}
      <Text onPress={() => navigation.navigate('manejoWebview', { title: secao3.link.titulo, url: secao3.link.url })} style={estilo.link}>{secao3.link.texto}</Text>
      </Paragraph>
    ),
    secao4 => (
      <Paragraph key="4">
        ...
        {secao4.texto1}
        <Text onPress={() => navigation.navigate('manejoWebview', { title: secao4.link.titulo, url: secao4.link.url })} style={estilo.link}>{secao4.link.texto}</Text>
      </Paragraph>
    ),
    secao5 => (
      <Paragraph key="5" style={estilo.margin8}>
        ...
        <Text onPress={() => navigation.navigate('manejoWebview', { title: secao5.link.titulo, url: secao5.link.url })} style={estilo.link}>{ secao5.link.texto }</Text>
      </Paragraph>
    ),
    secao6 => (
      <Paragraph key="6">
